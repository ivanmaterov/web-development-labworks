...
export class AuthService {
     ...
     * @throws ApiError
     */
    public static authPasswordChangeCreate(
     ...
     * @throws ApiError
     */
    public static authRegistrationCreate(
     ...
     * @throws ApiError
     */
    public static authRegistrationResendEmailCreate(
     ...
     * @throws ApiError
     */
    public static authRegistrationVerifyEmailCreate(
